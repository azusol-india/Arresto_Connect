...
public class IconSwitch extends ViewGroup {
...

    {
        ...
        thumbDragHelper = ViewDragHelper.create(this, new IconSwitch.ThumbDragCallback());
...
//        int colorDefInactive = getAccentColor();
        ...
        if (attr != null) {
            ...
            currentChecked = IconSwitch.Checked.values()[ta.getInt(R.styleable.IconSwitch_isw_default_selection, 0)];
            ta.recycle();
        } else {
            currentChecked = IconSwitch.Checked.LEFT;
        ...
        thumbPosition = currentChecked == IconSwitch.Checked.LEFT ? 0f : 1f;
    ...
    private void toggleSwitch() {
        ...
        int newLeft = currentChecked == IconSwitch.Checked.LEFT ? thumbStartLeft : thumbEndLeft;
    ...
    public void setCheckedChangeListener(IconSwitch.CheckedChangeListener listener) {
    ...
    private boolean isLeftChecked() {
        return currentChecked == IconSwitch.Checked.LEFT;
    }
    ...
    public void setChecked(IconSwitch.Checked newChecked) {
    ...
    public IconSwitch.Checked getChecked() {
    ...
    protected void onRestoreInstanceState(Parcelable parcel) {
        ...
        currentChecked = IconSwitch.Checked.values()[state.getInt(EXTRA_CHECKED, 0)];
        thumbPosition = currentChecked == IconSwitch.Checked.LEFT ? 0f : 1f;
        ensureCorrectColors();
    }
    ...
    private class ThumbDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            IconSwitch.Checked newChecked = newLeft == thumbStartLeft ? IconSwitch.Checked.LEFT : IconSwitch.Checked.RIGHT;
    ...
    public interface CheckedChangeListener {
        void onCheckChanged(IconSwitch.Checked current);
    }
