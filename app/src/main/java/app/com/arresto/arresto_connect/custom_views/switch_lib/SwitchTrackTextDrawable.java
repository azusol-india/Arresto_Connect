...
public class SwitchTrackTextDrawable extends Drawable {
    ...
    public SwitchTrackTextDrawable(@NonNull Context context, @StringRes int leftTextId, @StringRes int rightTextId) {
        mContext = context;
        // Left text
    ...
    private Paint createTextPaint() {
        ...
        textPaint.setColor(Dynamic_Var.getInstance().getApp_background());
        textPaint.setAntiAlias(true);
        textPaint.setStyle(Paint.Style.FILL);
        textPaint.setTextSize(AppUtils.getResSize(R.dimen.textsize));
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawText(mLeftText, 0, mLeftText.length(),widthQuarter, heightBaseline,mTextPaint);
        canvas.drawText(mRightText, 0, mRightText.length(),widthQuarter * 3, heightBaseline, mTextPaint);
    }
