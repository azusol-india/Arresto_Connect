...
public interface FlavourInfo {
     String Fl_CLIENT_ID = "931";
     String PACKAGE_NAME = "app.com.SteelPro";
     String APP_ID = "app.com.SteelPro";
     ...
     String webData = "<html>" +
             ...
             "<ol class=decimal>" +
             "<li class=decimal>Any use of the website and the mobile application named Konnect Pro Colombia (hereinafter mobile application referred to as the Konnect Pro Colombia Applications/ Application<sup>1</sup>), is subject to these Terms of Use.</li>" +
             "<li class=decimal>For the purposes of these Terms of Use, the term 'User' shall mean any person registering/ downloading or using the Konnect Pro Colombia Application. The term ‘User’ shall mean any person including registered licensee downloading or using the Konnect Pro Colombia Application after providing the requisite information in order to access the Konnect Pro Colombia Application. </li>" +
             "<li class=decimal>These Terms of Use are provided in an electronic format as prescribed under the Information Technology Act, 2000, the Rules made thereunder and the amendments regarding documents preserved in electronic format. These Terms of Use will govern the use of Konnect Pro Colombia Application by the User(s).</li>" +
             "<li class=decimal>Downloading, installing, browsing or otherwise using the Konnect Pro Colombia Application signifies acceptance of these Terms of Use as well as formal agreement to be legally bound by the same. </li>" +
             "<li class=decimal>These Terms of Use constitute the comprehensive terms and conditions for the use of the Konnect Pro Colombia Application. Any non-compliance with these Terms of Use may lead to disqualification from using the Konnect Pro Colombia Application.</li>" +
             ...
             "<li class=decimal>Any changes made to these Terms of Use will be effective immediately and any continued use of the Konnect Pro Colombia Application after such change constitutes acceptance of such changes.</li>" +
             "<li class=decimal>In order to use the Konnect Pro Colombia Application, agreement to these Terms of Use is the first step. The Terms of Use can be accepted by simply clicking on the space provided adjacent to I Agree to Terms & Conditions.</li>" +
             "<li class=decimal>The Konnect Pro Colombia Application must not be used in any manner or case where there is non-acceptance of these Terms of Use or inability to be bound by them." +
             "</li>" +
             "</ol>" +
             "</li>" +
             ...
             "<ol type=i>" +
             "<li>Provide true, accurate, current and complete information as prompted by the Konnect Pro Colombia Application’s registration form while registering (such information being the Registration data);</li>" +
             "<li>Maintain and promptly update the Registration data to keep it true, accurate, current and complete at all times;</li>" +
             "<li>Immediately notifying the Konnect Pro Colombia Application of any unauthorized use of password or account or any other actual or suspected breach of security; and</li>" +
             ...
             "<li class=decimal>As the first step of the Registration process, the Konnect Pro Colombia Application may require the following PII to be provided, including without limitation to: " +
             "<ul>" +
             ...
             "</ul></li>" +
             "<p>Upon collection, the above-mentioned information shall be subject to the Privacy Policy of the Konnect Pro Colombia Application.</p>" +
             ...
             "<p>In case a User does not adhere to the above conditions, the providers of the Konnect Pro Colombia Application reserve the right to refuse registration of or cancel registration of such User in its discretion.</p>" +
             "</li>" +
             "<li class=decimal>Internet Carrier charges levied for the use of the Konnect Pro Colombia Application shall be borne by the User(s) himself/ herself.</li>" +
             ...
             "<ol type=i>" +
             "<li>For improving services offered and received using the Konnect Pro Colombia Application;</li>" +
             "<li>For keeping internal records;</li>" +
             "<li>For market research purposes;</li>" +
             "<li>For the purpose of enhancing User's experience.</li>" +
             "</ol>" +
             "<li class=decimal>In case a User changes his/ her mind and wishes to discontinue sharing his/ her PII, he/ she/ it may express such intention by mailing <mailto:customercare@karam.in.>customercare@karam.in.</mailto:></li>" +
             "<li class=decimal>The providers of the Konnect Pro Colombia Application reserve the right at all times to disclose any information as may be required by law. This may include disclosure of information for investigation of an alleged illegal activity or its response to a lawful court order.</li>" +
             ...
             "<ol class=decimal>" +
             "<li class=decimal>The Users shall use the Konnect Pro Colombia Application solely for personal and non-commercial purposes.</li> " +
             "<li class=decimal>The Users shall not decompile, reverse engineer, or disassemble the contents of the Konnect Pro Colombia Application or modify, copy, distribute, transmit, display, perform, reproduce, publish, license, create derivative works from, transfer, or sell any information obtained from the use of Konnect Pro Colombia Application. </li>" +
             "<li class=decimal>The User shall not use the Konnect Pro Colombia Application in any way that is unlawful or harms the goodwill or reputation of the providers of the Konnect Pro Colombia Application. </li> " +
             "<li class=decimal>The User shall not use the Konnect Pro Colombia Application in any way which:" +
             "<ol type=i>" +
             "<li>Interferes with another person’s use of the Konnect Pro Colombia Application;</li>" +
             ...
             "<li>Uses the Konnect Pro Colombia Application in any manner that could damage, disable, overburden or impair any of the servers or the networks connected to any of the servers on which the Konnect Pro Colombia Application is hosted;</li>" +
             "<li>Use the Konnect Pro Colombia Application for purposes that are not permitted by these Terms of Use or any applicable law, regulation or generally accepted practices or guidelines in the relevant jurisdiction.</li>" +
             "</ol>" +
             "</li>" +
             "</ol>" +
             "</li>" +
             ...
             "<ol class=decimal>" +
             "<li class=decimal>The User’s access to the Konnect Pro Colombia Application may be occasionally suspended or restricted for the purpose of repairs, maintenance, or the introduction of new facilities or services at any time without prior notice.</li>" +
             "<li class=decimal>There is no warranty, representation or guarantee that the Konnect Pro Colombia Application, or the use thereof will be uninterrupted, complete, accurate, current, reliable, error-free, secure, or that any problems will be corrected, or that any information, software or other material accessible from the Konnect Pro Colombia Application is free from viruses or other harmful components.</li>" +
             ...
             "<ol class=decimal>" +
             "<li class=decimal>Intellectual Property of the providers of the Konnect Pro Colombia Application remains with the providers which includes, but is not limited to, innovations, improvements, processes, technical know-how, techniques, source code of the providers of the Konnect Pro Colombia Application, content made literary and artistic works, schematics, patents, proposed trade secrets, its trademarks, trade names, designs, patents and copyrighted works, notes, agreements/ contracts entered by the providers of the Konnect Pro Colombia Application, formulas, in-house software, VPN etc.. providers of the Konnect Pro Colombia Application reserve the right to take any legal recourse available for the protection of its Intellectual Property.</li>" +
             "<li class=decimal>All intellectual property rights including trademarks, & copyright of the Konnect Pro Colombia Application and the Konnect Pro Colombia Application shall vest in all the providers. It is clarified that the ownership in intellectual property rights pertaining to the Konnect Pro Colombia Application developed by the content developer shall vest with the content developer and the User shall not indulge in any act that construes such infringement of the intellectual property of the providers of the Konnect Pro Colombia Application.</li>" +
             "<li class=decimal>User shall not use, receive or copy any source code and look and feel of the Konnect Pro Colombia Application and shall not reverse engineer, disassemble or decompile, or otherwise attempt to derive source code of the Konnect Pro Colombia Application for any purpose whatsoever. </li>" +
             "<li class=decimal>Access or use of the Konnect Pro Colombia Application does not confer and shall not be construed as conferring upon anyone the license to use the Intellectual Property Rights of the providers of the Konnect Pro Colombia Application.</li>" +
             "</ol>" +
             "</li>" +
             "<li class=decimal><u><strong>Posting of Content</strong></u>" +
             "<ol class=decimal>" +
             "<li class=decimal>The providers of the Konnect Pro Colombia Application enable their User(s) to post messages, photographs and video in a various segment as may be desired by User(s) depending on the area, city, state or country the Users in their respective segments will receive the concerned User’s post.</li>" +
             ...
             "<li class=decimal>The providers of the Konnect Pro Colombia Application are under no obligation to monitor or control the Content posted on the Konnect Pro Colombia Application and, the providers of the Konnect Pro Colombia Application cannot take responsibility of the correctness and accuracy of such Content. Any use or reliance on any Content or materials posted on the Konnect Pro Colombia Application or obtained by the User on the Konnect Pro Colombia Application is at the User’s own risk and prudence. </li>" +
             "<li class=decimal>The providers of the Konnect Pro Colombia Application do not endorse, support, represent or guarantee the completeness, truthfulness, accuracy, or reliability of any Content or communications posted on the Konnect Pro Colombia Application or endorse any opinions expressed on the Konnect Pro Colombia Application.</li>" +
             "<li class=decimal>The User understands that by using the Konnect Pro Colombia Application, the User may be exposed to Content that might be offensive, harmful, inaccurate or otherwise inappropriate, or in some cases, Content that have been mislabeled or are otherwise deceptive. Under no circumstances will the providers of the Konnect Pro Colombia Application be liable in any way for any Content whatsoever, including, but not limited to, any errors or omissions in any Content, or any loss or damage of any kind incurred as a result of the use of any Content posted, emailed, transmitted or otherwise made available on the Konnect Pro Colombia Application.</li>" +
             "<li class=decimal>The providers of the Konnect Pro Colombia Application reserve the right to modify or adapt the User’s Content in order to transmit, display or distribute it over computer networks and in various media and/or make changes to the Content as are necessary to conform and adapt that Content to any requirements or limitations of any networks, devices, services or media.</li>" +
             "<li class=decimal>The User agrees that he/she is responsible for use of the Konnect Pro Colombia Application, for any Content provided, and for any consequences thereof, including the use of Content by other users and third-party associates of the providers of the Konnect Pro Colombia Application.</li>" +
             ...
             "<ol class=decimal>" +
             "<li class=decimal>The User is solely responsible for properly deleting his/ her account, by sending an email to <mailto:customercare@karam.in.>customercare@karam.in.</mailto:></li>" +
             "<li class=decimal>All of the User’s content will immediately be inaccessible from the Konnect Pro Colombia Application upon deletion. Within 30 days, all this content will be permanently deleted from all backups and logs. This information cannot be recovered once it has been permanently deleted.</li>" +
             "<li class=decimal>The providers of the Konnect Pro Colombia Application, in their sole discretion, has the right to suspend or terminate the User’s account in case of prolonged inactivity or misuse of the Konnect Pro Colombia Application which is a violation of any provision(s) of these Terms of Use or violation of any applicable law. Such termination will result in the deactivation or deletion of the User’s account or access to the account, and the forfeiture and relinquishment of all Content in the account. The providers of the Konnect Pro Colombia Application reserve the right to refuse service to anyone for any reason at any time. </li>" +
             "</ol>" +
             "</li>" +
             "<li class=decimal><u><strong>Right to monitor the content</strong></u>" +
             "<p>The providers of the Konnect Pro Colombia Application reserve the right to monitor the Content available on the Konnect Pro Colombia Application whether made available by itself or by any User.</p>" +
             "</li>" +
             "<li class=decimal><u><strong>Indemnification</strong></u>" +
             "<p>The User agrees to indemnify, defend and hold harmless the providers of the Konnect Pro Colombia Application, and their affiliates and their officers, directors, employees, contractors, agents, licensors, service providers, subcontractors and suppliers from and against any and all losses, liabilities, expenses, damages and costs, including reasonable attorneys' fees and court costs, arising or resulting from the use of the Konnect Pro Colombia Application and any violation of these Terms of Use or any applicable law.</p>" +
             "</li>" +
             "<li class=decimal><u><strong>Limitation of Liability</strong></u>" +
             "<p>To the fullest extent permitted by applicable laws, in no event shall the providers of the Konnect Pro Colombia Application be liable for any damages resulting from any of the following:</p>" +
             "<ol type=i>" +
             "<li>errors, mistakes, or inaccuracies of content;</li>" +
             "<li>personal injury or property damage, of any nature whatsoever, resulting from access to and use of the Services including the Konnect Pro Colombia Application;</li>" +
             ...
             "<li>any errors or omissions in any content or for any loss or damage of any kind incurred as a result of the Users utilizing of any content posted, transmitted, or otherwise made available via the Konnect Pro Colombia Application, whether based on warranty, contract, tort, or any other legal theory;</li>" +
             ...
             "<p>The providers of the Konnect Pro Colombia Application shall not be liable for failure to perform or any delay in performance of services when and to extent that such failure or delay is due to force majeure." +
             "</p>" +
             "</li>" +
             "<li class=decimal><u><strong>Dispute Resolution</strong></u>" +
             "<ol type=a>" +
             "<li>Where any dispute or disagreement arises between the providers of the Konnect Pro Colombia Application and the User as to the interpretation or application of any of the terms, conditions, requirements or obligations under these Terms of Use or use of the Konnect Pro Colombia Application, such dispute or disagreement shall be amicably resolved vide mutual discussions. </li>" +
             ...
             "<p>These Terms of Use shall be governed by the laws of Republic of India and the User(s) willing to utilize the <b>Konnect Pro Colombia Application</b> hereby consents to the exclusive jurisdiction of courts in India in all disputes arising out of or relating to the use of the <b>Konnect Pro Colombia Application</b>. Use of the <b>Konnect Pro Colombia Application</b> is unauthorized in any jurisdiction that does not give effect to all provisions of these Terms of Use, including but without limitation to this paragraph. </p>" +
             "</li>" +
             ...
             "<li class=decimal>This Privacy Policy explains the policy of the providers of the Konnect Pro Colombia Application regarding the collection, use, disclosure and transfer of the User's personally identification information in relation with the use of the Konnect Pro Colombia Application including but not limited to delivery of information and content. </li>" +
             "<li class=decimal>This Privacy Policy forms part and parcel of the Terms of Use for the use of Konnect Pro Colombia Application and the effective date when this Privacy Policy comes into force will be the date when the User first uses the Konnect Pro Colombia Application.</li>" +
             ...
             "<ol class=decimal>" +
             "<li class=decimal>Users who use and/or register on the Konnect Pro Colombia Application will be requested to provide their PII. The PII is used for efficient service and better user experience for the User.</li> " +
             "<li class=decimal>By accessing the Konnect Pro Colombia Application or otherwise using the Services, the User consents to collection, storage, and use of the PII provided by him/her (including any changes thereto as provided) to avail any of the Services that the providers of the Konnect Pro Colombia Application offer. </li>" +
             ...
             "<li class=decimal>The providers of the Konnect Pro Colombia Application respect the privacy of the Users and are committed to reasonably protect it in all respects. The types of information about the User which may be collected by the providers of the Konnect Pro Colombia Application are as follows:</li>" +
             "<ol type=i>" +
             ...
             "<p>While signing up on the Konnect Pro Colombia Application and accessing the Konnect Pro Colombia Application, the application form collects the information, including but not limited to:</p>" +
             "<ul>" +
             ...
             "<p>THE PROVIDERS OF THE Konnect Pro Colombia APPLICATION MAY ALSO COLLECT INFORMATION THROUGH THE USER'S INTERACTION WITH AND USE OF THE Konnect Pro Colombia APPLICATION WHICH DOES NOT REVEAL THE USER'S SPECIFIC IDENTITY OR DOES NOT DIRECTLY RELATE TO AN INDIVIDUAL. SUCH INFORMATION MAY INCLUDE, BUT IS NOT LIMITED TO, BROWSER AND DEVICE INFORMATION, DATA COLLECTED THROUGH AUTOMATED ELECTRONIC INTERACTIONS, Konnect Pro Colombia APPLICATION USAGE DATA, DEMOGRAPHIC INFORMATION, GEOGRAPHIC OR GEO-LOCATION INFORMATION, STATISTICAL AND AGGREGATED INFORMATION. </p>" +
             "<u><strong>INFORMATION COLLECTED FROM ANY OTHER SOURCE</strong></u>" +
             "<p>THE PROVIDERS OF THE Konnect Pro Colombia APPLICATION MAY RECEIVE INFORMATION ABOUT THE USER FROM OTHER PUBLIC SOURCES, ADD IT TO THE USER ACCOUNT INFORMATION AND TREAT IT IN ACCORDANCE WITH THIS POLICY. IF THE USER PROVIDES INFORMATION TO THE PLATFORM PROVIDER OR OTHER PARTNER, WHOM THE SERVICES ARE PROVIDED, THE USER'S ACCOUNT INFORMATION AND ORDER INFORMATION MAY BE PASSED ON TO THE PROVIDERS OF THE Konnect Pro Colombia APPLICATION. THE PROVIDERS OF THE Konnect Pro Colombia APPLICATION AND THEIR CONTENT DEVELOPER MAY OBTAIN UPDATED CONTACT INFORMATION AVAILABLE IN PUBLIC DOMAIN FROM THIRD PARTIES IN ORDER TO CORRECT RECORDS AND PROVIDE THE SERVICES OR TO COMMUNICATE WITH THE USER. </p>" +
             "</li>" +
             ...
             "<li class=decimal>The PII of the User(s) excluding pictures, videos and contact details may be used to deliver advertising, marketing and event-based communication. Such communication may contain option to opt out of receiving such communications in future. If the User choses to opt out of receiving such marketing and event-based communication by emailing at customercare@karam.in, then the providers of the Konnect Pro Colombia Application shall not contact such User and will ensure that new data collected about the User(s) from then on will not be used by the providers of the Konnect Pro Colombia Application for any targeted advertising purposes. However, the providers of the Konnect Pro Colombia Application may use existing information of the User(s) to customize the Konnect Pro Colombia Application accordingly.</li>" +
             "<li class=decimal>The providers of the Konnect Pro Colombia Application may use the PII of the User(s) for internal and external research and development purposes and to improve and test the features and functions of the Konnect Pro Colombia Application for giving the best options to the Users.</li>" +
             ...
             "<li class=decimal>The providers of the Konnect Pro Colombia Application may use and retain the PII of the User(s) for legal and compliance reasons, such as the prevention, detection, or investigation of a crime; loss prevention; fraud, or to meet our internal and external audit requirements, information security purposes, and or which is required (a) under applicable law (b) to respond to requests from courts, law enforcement agencies, regulatory agencies, and other public and government authorities, (c) to enforce the Terms And Conditions; and (d) to protect the rights, privacy, safety, or property of the providers of the Konnect Pro Colombia Application.</li>" +
             ...
             "<li class=decimal>The providers of the Konnect Pro Colombia Application may also use the PII of the User(s) collected for the following purposes:" +
             "<ol type=i>" +
             "<li>To facilitate various programs and initiatives launched by the providers of the Konnect Pro Colombia Application or third-party service providers and business associates;</li>" +
             "<li>To analyze how the Services are used, to measure the effectiveness of advertisements, to facilitating payments;</li>" +
             "<li>To protect the integrity of the Konnect Pro Colombia Application;</li>" +
             ...
             "<li>To enhance ability of the providers of the Konnect Pro Colombia Application to communicate with Users and customers about additional valuable services; </li>" +
             "<li>To ensure fulfillment of a Contract;</li>" +
             "<li>to trace computer resources or any person who may have contravened, or is suspected of having or being likely to contravene, any provision of law including the Information Technology Act, 2000 that is likely to have an adverse impact on the services provided on the Konnect Pro Colombia Application or by the providers of the Konnect Pro Colombia Application .</li>" +
             ...
             "<p>The providers of the Konnect Pro Colombia Application may share User information with third parties, including service providers, regulated institutions), affiliated entities, payment processing service providers and business partners for the following purposes:</p>" +
             "<ol class=decimal>" +
             "<li class=decimal>Information may be shared with the service providers and affiliates of the providers of the Konnect Pro Colombia Application to assist in provision of Services and everyday business purpose.</li>" +
             ...
             "<li class=decimal>Information may be shared if the providers of the Konnect Pro Colombia Application believe it necessary to disclose information to investigate, prevent or take action regarding illegal activities, suspend fraud, violations of Terms of Use or this Privacy Policy. </li>" +
             "</ol>" +
             "</li>" +
             "<li class=decimal><u><strong>COOKIES</strong></u>" +
             "<p>The providers of the Konnect Pro Colombia Application may use cookies to operate and provide Services, to improve experiences of the User(s), understand how services are being used, and customize services as per the User's needs and choices. Additionally, cookies may be used to remember choices, such as language preferences, and otherwise to customize services for the User. </p>" +
             "<p>A cookie in no way gives the providers of the Konnect Pro Colombia Application access to the User's computer or any information about them, other than the data they choose to share with the providers of the Konnect Pro Colombia Application. The User(s) can choose to accept or decline cookies.</p>" +
             "<p>The helpportion of the toolbar on most browsers will tell the Users how to prevent their browser from accepting new cookies, how to have the browser notify then when they receive a new cookie, or how to disable cookies altogether. However, cookies will allow Users to take full advantage of some of the Konnect Pro Colombia Application features and it is recommended to leave them turned on. </p>" +
             "</li>" +
             "<li class=decimal><u><strong>LOG FILES</strong></u>" +
             "<p>The providers of the Konnect Pro Colombia Application maintain log files of the traffic that visits the Service. The providers of the Konnect Pro Colombia Application do not link any information gathered in these log files to PII. Log files are used to manage traffic loads and information technology requirements for providing reliable service.</p>" +
             "</li>" +
             "<li class=decimal><u><strong>THIRD PARTY LINKS</strong></u>" +
             "<p>The Konnect Pro Colombia Application also includes links to other websites. Such websites are governed by their respective privacy policies, which are beyond the control of the providers of the Konnect Pro Colombia Application. Once the User leaves the servers of the providers of the Konnect Pro Colombia Application, use of any information provided by the User is governed by the privacy policy of the operator of the site which the User is visiting. That policy may differ from that of the providers of the Konnect Pro Colombia Application. If the User can't find the privacy policy of any of these sites via a link from the concerned third party's website, the User may contact the concerned third party directly for more information. The providers of the Konnect Pro Colombia Application is not responsible for the privacy practices or the content of such websites.</p>" +
             "</li>" +
             "<li class=decimal><u><strong>INFORMATION SECURITY</strong></u>" +
             "<p>The security of PII is important to the providers of the Konnect Pro Colombia Application. The providers of the Konnect Pro Colombia Application follow generally accepted industry standards to protect the PII submitted by User(s). However, no method of transmission over the Internet or method of electronic storage can be said to be 100% secure, therefore, while it is attempted to use commercially acceptable means to protect PII, there is no guarantee of absolute security. </p>" +
             "<p>The User(s) is responsible for all uses of his/her username and password created at the time of signing up on the Konnect Pro Colombia Application. Please contact the providers of the Konnect Pro Colombia Application immediately if the User(s) believes password has been misused. The Users shall be individually responsible for maintaining the confidentiality of their username and password and for all activities occurring under their account. The providers of the Konnect Pro Colombia Application shall not be liable for any misuse or unauthorized use of username and password of the User(s).</p>" +
             "</li>" +
             "<li class=decimal><u><strong>RETENTION OF INFORMATION</strong></u>" +
             "<p>The PII of the User(s) will be kept by the providers of the Konnect Pro Colombia Application for as long it is necessary to fulfil the purpose for which it was collected, or as required or permitted by applicable laws. The providers of the Konnect Pro Colombia Application will cease to retain PII of users, or remove the means by which the data can be associated with Users, as soon as it is reasonable to assume that such retention no longer serves the purpose for which the personal data was collected, and is no longer necessary for legal or business purposes. The providers of the Konnect Pro Colombia Application shall at all times assume that the information provided by the User(s) is correct, genuine and updated. The providers of the Konnect Pro Colombia Application shall not be held liable for any false/ incorrect information/ data of the User/s. The User shall indemnify the providers of the Konnect Pro Colombia Application in case of any loss, damage or injury caused to it due to the use or lawful disclosure of false data provided by the User(s).</p>" +
             "</li>" +
             "<li class=decimal><u><strong>SPAMMING</strong></u>" +
             "<p>It is contrary to this policy for User(s) to use the Konnect Pro Colombia Application to effect or participate in any of the following activities:</p>" +
             "<ol class=decimal>" +
             ...
             "<li class=decimal>To falsify User(s) information provided in the Konnect Pro Colombia Application or to other User(s) of the Service in connection with use of the Service.</li>" +
             "</ol>" +
             "</li>" +
             "<li class=decimal><u><strong>THIRD PARTY DISCLOSURES</strong></u>" +
             "<p>The providers of the Konnect Pro Colombia Application do not sell, trade, lend, transfer or disclose any PII collected from the User(s) to third parties except as set forth in this Privacy Policy. However, the providers of the Konnect Pro Colombia Application reserve the right to provide the PII to its employees or partners or agents who have a need-to-know such information for the purpose of maintenance and development of the Konnect Pro Colombia Application and enabling the providers of the Konnect Pro Colombia Application to provide Services to the User(s). However, this does not include trusted third parties such as contractors and vendors who assist the providers of the Konnect Pro Colombia Application in operating the Service, conducting business, or servicing the users, so long as those parties agree to keep this information confidential. </p>" +
             "<p>The providers of the Konnect Pro Colombia Application also reserves the right to disclose PII when special circumstances call for it, such as when disclosure is required by law or court order or when disclosure is, in the sole discretion of the providers of the Konnect Pro Colombia Application, necessary to protect legal rights, including intellectual property rights." +
             "</p>" +
             "</li>" +
             "<li class=decimal><u><strong>VIOLATION OF THE POLICY</strong></u>" +
             "<p>Upon becoming aware of an alleged violation of this Policy or Terms of Use, the providers of the Konnect Pro Colombia Application may initiate an investigation. During the investigation, the User's access to the Service may be suspended, restricted or limited in order to prevent further unauthorized activities. Depending on the severity of the violation, the providers of the Konnect Pro Colombia Application may, at its sole discretion, restrict, suspend, or terminate User's account and pursue other civil remedies. If such violation is a criminal offence the providers of the Konnect Pro Colombia Application will notify the appropriate Government authority of such violation.</p>" +
             "</li>" +
             ...
             "<p>The providers of the Konnect Pro Colombia Application have appointed an internal data protection officer for the Users to contact if a User has any queries, clarifications or complaints regarding compliance with this Policy or relating to processing of information. The data protection officer's name and contact information are provided below:</p>" +
             "Name: Karam Industries<br>" +
             "Email id: <mailto:customercare@karam.in>customercare@karam.in</mailto:><br>" +
             ...
             "" +
             "ng></u>" +
             "<p>While dealing with data subjects of the European Union, the providers of the Konnect Pro Colombia Application take measures to comply with General data Protection Regulation (GDPR). Under GDPR, User(s) have the right to access their PII submitted to the providers of the Konnect Pro Colombia Application for any purpose. The Users can get access to their PII across any services at any time.</p>" +
             "</li>" +
             "<li class=decimal><u><strong>WITHDRAWAL OF CONSENT</strong></u>" +
             "<p>The consent provided to the providers of the Konnect Pro Colombia Application for collection and use of PII may be withdrawn at any time by contacting at <mailto:customercare@karam.in>customercare@karam.in</mailto:></p>" +
             "</li>" +
     ...
     String webData_spenish = "<html>" +
             ...
             " <ol class = decimal>" +
             " <li class = decimal> Cualquier uso del sitio web y la aplicación móvil denominada Konnect Pro Colombia (en adelante, la aplicación móvil denominada Aplicaciones / Aplicación Konnect Pro Colombia <sup> 1 </sup>), está sujeto a estos Términos de uso. </li>" +
             "<li class = decimal> Para los propósitos de estos Términos de uso, el término 'Usuario' significará cualquier persona que se registre / descargue o utilice la Aplicación Konnect Pro Colombia. El término 'Usuario' significará cualquier persona, incluido el licenciatario registrado, que descargue o utilice la Aplicación Konnect Pro Colombia después de proporcionar la información necesaria para acceder a la Aplicación Konnect Pro Colombia. </li>" +
             "<li class = decimal> Estos Términos de uso se proporcionan en formato electrónico según lo prescrito en la Ley de tecnología de la información de 2000, las Reglas establecidas en virtud de las mismas y las enmiendas relativas a los documentos conservados en formato electrónico. Estos Términos de uso regirán el uso de la Aplicación Konnect Pro Colombia por parte del Usuario (s). </li>" +
             "<li class = decimal> Descargar, instalar, navegar o usar la Aplicación Konnect Pro Colombia significa la aceptación de estos Términos de uso, así como un acuerdo formal de estar legalmente obligado por los mismos. </li>" +
             "<li class = decimal> Estos Términos de uso constituyen los términos y condiciones completos para el uso de la Aplicación Konnect Pro Colombia. Cualquier incumplimiento de estos Términos de uso puede dar lugar a la descalificación del uso de la Aplicación Konnect Pro Colombia. </li>" +
             ...
             " <li class = decimal> Cualquier cambio realizado en estos Términos de uso entrará en vigencia de inmediato y cualquier uso continuado de la Aplicación Konnect Pro Colombia después de dicho cambio constituye la aceptación de dichos cambios. </li>" +
             "<li class = decimal> Para utilizar la aplicación Konnect Pro Colombia, el primer paso es aceptar estos Términos de uso. Los Términos de uso se pueden aceptar simplemente haciendo clic en el espacio provisto junto a Acepto los Términos y condiciones. </li>" +
             "<li class = decimal> La aplicación Konnect Pro Colombia no debe usarse de ninguna manera o caso en el que no haya aceptación de estos Términos de uso o no pueda estar sujeto a ellos. </li>" +
             " </ol>" +
             " </li>" +
             ...
             " <ol type = i>" +
             " <li> Proporcione información verdadera, precisa, actual y completa según lo solicite el formulario de registro de la Solicitud de Konnect Pro Colombia al registrarse (dicha información son los Datos de registro); </li>" +
             ...
             "<li> Notificar inmediatamente a la Aplicación Konnect Pro Colombia de cualquier uso no autorizado de contraseña o cuenta o cualquier otra violación de seguridad real o sospechada; y </li>" +
             ...
             " <li class = decimal> Como primer paso del proceso de registro, la aplicación Konnect Pro Colombia puede requerir que se proporcione la siguiente PII, que incluye, entre otros, los siguientes:" +
             " <ul>" +
             ...
             " </ul>" +
             " Una vez recopilada, la información mencionada anteriormente estará sujeta a la Política de privacidad de la aplicación Konnect Pro Colombia." +
             " </li>" +
             ...
             " </ol>" +
             " En caso de que un Usuario no cumpla con las condiciones anteriores, los proveedores de la Aplicación Konnect Pro Colombia se reservan el derecho de rechazar el registro o cancelar el registro de dicho Usuario a su discreción." +
             " </li>" +
             " <li class = decimal> Los cargos del Operador de Internet cobrados por el uso de la Aplicación Konnect Pro Colombia correrán a cargo del Usuario (s) mismo. </li>" +
             ...
             " <ol type = i>" +
             " <li> Para mejorar los servicios ofrecidos y recibidos usando la aplicación Konnect Pro Colombia; </li>" +
             ...
             " <ol class = decimal>" +
             " <li class = decimal> Los Usuarios utilizarán la Aplicación Konnect Pro Colombia únicamente para fines personales y no comerciales. </li>" +
             ...
             "<li class = decimal> El Usuario no utilizará la Aplicación Konnect Pro Colombia de ninguna manera que sea ilegal o perjudique la buena voluntad o reputación de los proveedores de la Aplicación Konnect Pro Colombia. </li>" +
             " <li class = decimal> El Usuario no podrá utilizar la Aplicación Konnect Pro Colombia de ninguna manera que:" +
             " <ol type = i>" +
             " <li> Interfiere con el uso de la aplicación Konnect Pro Colombia por otra persona; </li>" +
             ...
             " <li> Utiliza la Aplicación Konnect Pro Colombia de cualquier manera que pueda dañar, deshabilitar, sobrecargar o deteriorar cualquiera de los servidores o las redes conectadas a cualquiera de los servidores en los que está alojada la Aplicación Konnect Pro Colombia; </li>" +
             " <li> Utilice la aplicación Konnect Pro Colombia para fines que no estén permitidos por estos Términos de uso o cualquier ley, regulación o prácticas o pautas generalmente aceptadas en la jurisdicción correspondiente. </li>" +
             " </ol>" +
             " </li>" +
             " </ol>" +
             " </li>" +
             ...
             " <ol class = decimal>" +
             " <li class = decimal> El acceso del Usuario a la Aplicación Konnect Pro Colombia puede ser ocasionalmente suspendido o restringido con el propósito de reparaciones, mantenimiento o la introducción de nuevas instalaciones o servicios en cualquier momento sin previo aviso. </li>" +
             ...
             "<li class = decimal> El usuario no debe usar, recibir o copiar ningún código fuente y apariencia de la aplicación Konnect Pro Colombia y no debe realizar ingeniería inversa, desensamblar o descompilar, o intentar derivar el código fuente del Konnect Pro. Colombia Aplicación para cualquier propósito. </li>" +
             " <li class = decimal> El acceso o uso de la Aplicación Konnect Pro Colombia no confiere ni se interpretará como una concesión a nadie de la licencia para usar los Derechos de Propiedad Intelectual de los proveedores de la Aplicación Konnect Pro Colombia. </ li >" +
             " </ol>" +
             " </li>" +
             ...
             " Los proveedores de la Aplicación Konnect Pro Colombia se reservan el derecho de monitorear el Contenido disponible en la Aplicación Konnect Pro Colombia, ya sea que esté disponible por ellos mismos o por cualquier Usuario." +
             " </li>" +
             " <li class = decimal> <u> <strong> Indemnización </strong> </u> <br>" +
             " El Usuario acepta indemnizar, defender y eximir de responsabilidad a los proveedores de la Aplicación Konnect Pro Colombia, y sus afiliados y sus funcionarios, directores, empleados, contratistas, agentes, licenciantes, proveedores de servicios, subcontratistas y proveedores de y contra cualquier y todas las pérdidas. responsabilidades, gastos, daños y costos, incluidos los honorarios razonables de abogados y costos judiciales, que surjan o resulten del uso de la Aplicación Konnect Pro Colombia y cualquier violación de estos Términos de uso o cualquier ley aplicable." +
             " </li>" +
             " <li class = decimal> <u> <strong> Limitación de responsabilidad </strong> </u> <br>" +
             " En la máxima medida permitida por las leyes aplicables, en ningún caso los proveedores de la Aplicación Konnect Pro Colombia serán responsables de los daños que resulten de cualquiera de los siguientes:" +
             " <ol type = i>" +
             " <li> errores, errores o inexactitudes del contenido; </li>" +
             " <li> lesiones personales o daños a la propiedad, de cualquier naturaleza, como resultado del acceso y uso de los Servicios, incluida la Aplicación Konnect Pro Colombia; </li>" +
             ...
             " <li class = decimal> Esta Política de Privacidad forma parte integral de los Términos de Uso para el uso de la Aplicación Konnect Pro Colombia y la fecha de vigencia cuando esta Política de Privacidad entre en vigencia será la fecha en la que el Usuario use Konnect por primera vez. Aplicación Pro Colombia. </li>" +
             ...
             " <ol class = decimal>" +
             "<li class = decimal> Se pedirá a los usuarios que utilicen y / o se registren en la aplicación Konnect Pro Colombia que proporcionen su PII. La PII se utiliza para un servicio eficiente y una mejor experiencia de usuario para el Usuario. </li>" +
             ...
             " Al registrarse en la aplicación Konnect Pro Colombia y acceder a la aplicación Konnect Pro Colombia, el formulario de solicitud recopila la información, que incluye, entre otros:" +
             " <ul>" +
             ...
             " <li class = decimal> Los proveedores de la Aplicación Konnect Pro Colombia también pueden utilizar la PII del Usuario (s) recopilada para los siguientes propósitos:" +
             " <ol type = i>" +
             " <li> Facilitar varios programas e iniciativas lanzadas por los proveedores de la Aplicación Konnect Pro Colombia o proveedores de servicios externos y socios comerciales; </li>" +
             " <li> Para analizar cómo se utilizan los Servicios, para medir la efectividad de los anuncios, para facilitar los pagos; </li>" +
             " <li> Para proteger la integridad de la aplicación Konnect Pro Colombia; </li>" +
             ...
             "<li> Mejorar la capacidad de los proveedores de la aplicación Konnect Pro Colombia para comunicarse con los usuarios y clientes sobre servicios valiosos adicionales; </li>" +
             ...
             " Los proveedores de la Aplicación Konnect Pro Colombia pueden compartir la información del Usuario con terceros, incluidos proveedores de servicios, instituciones reguladas), entidades afiliadas, proveedores de servicios de procesamiento de pagos y socios comerciales para los siguientes propósitos:" +
             " <ol class = decimal>" +
             " <li class = decimal> La información se puede compartir con los proveedores de servicios y afiliados de los proveedores de la Aplicación Konnect Pro Colombia para ayudar en la prestación de Servicios y el propósito comercial diario. </li>" +
             ...
             "Los proveedores de la Aplicación Konnect Pro Colombia pueden usar cookies para operar y proporcionar Servicios, para mejorar las experiencias del Usuario (s), comprender cómo se utilizan los servicios y personalizar los servicios según las necesidades y elecciones del Usuario. Además, las cookies pueden usarse para recordar opciones, como preferencias de idioma, y de otro modo para personalizar los servicios para el Usuario." +
             " <br>" +
             ...
             " Es contrario a esta política que los usuarios utilicen la aplicación Konnect Pro Colombia para realizar o participar en cualquiera de las siguientes actividades:" +
             " <ol class = i>" +
             ...
             " Nombre: VICSA STEELPRO COLOMBIA SAS <br>" +
             "ID de correo electrónico: <a href=mailto: servicio.cliente@vicsacolombia.com > servicio.cliente@vicsacolombia.com </a> <br>" +
             " N ° de teléfono: +57318 2855054 <br>" +
             " " +
             ...
             "El consentimiento otorgado a los proveedores de la Aplicación Konnect Pro Colombia para la recopilación y uso de PII puede ser retirado en cualquier momento contactando a <a href=mailto: servicio.cliente@vicsacolombia.com > servicio.cliente@vicsacolombia.com </a>" +
             " </li>" +
     ...
     String server_alert ="<html>" +
             "<h3 align=center>&quotKonnect Pro Colombia Application Updation&quot</h3>" +
